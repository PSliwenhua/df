...
BOOL CMT2300A_AutoSwitchStatus(u8 nGoCmd)
{
    ...
    u16 nBegTick = CMT2300A_GetTickCount();
    u8  nWaitStatus = 0;
...
//    tmp &= ~CMT2300A_MASK_FIFO_RX_TX_SEL;
    CMT2300A_WriteReg(CMT2300A_CUS_FIFO_CTL, 0);
}
...
//    tmp |= CMT2300A_MASK_SPI_FIFO_RD_WR_SEL;
//    tmp |= CMT2300A_MASK_FIFO_RX_TX_SEL;
    CMT2300A_WriteReg(CMT2300A_CUS_FIFO_CTL, CMT2300A_MASK_SPI_FIFO_RD_WR_SEL+CMT2300A_MASK_FIFO_RX_TX_SEL);
}
...
{
	CMT2300A_WriteReg(CMT2300A_CUS_INT_CLR1, 0x07);
    CMT2300A_WriteReg(CMT2300A_CUS_INT_CLR2, 0x3F);
}
...
{ 
   ...
   // tmp = nLength & CMT2300A_MASK_PAYLOAD_LENG_7_0;
    CMT2300A_WriteReg(CMT2300A_CUS_PKT15, nLength);
}
